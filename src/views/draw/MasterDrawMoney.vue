...
<script lang="ts">
  ...
  import { masterDrawMoneyPage, masterDrawMoneyAudit } from '/@/api/trade';
  import { FETCH_SETTING } from '/@/api/const';
  import { MasterColumns, ExBrokerColumns } from './config';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      function opHis() {
        router.push({ name: 'His', params: { role: 'master' } });
      }
